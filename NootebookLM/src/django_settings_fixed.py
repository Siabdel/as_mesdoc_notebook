...
VERSION CORRIGÉE avec INSTALLED_APPS complet.
"""
...
INSTALLED_APPS = [
    ...
    # Third-party apps
    'rest_framework',
    'rest_framework.authtoken',  # Ajout pour l'authentification par token
    'corsheaders',
    
    # Apps locales - IMPORTANT: notation complète avec 'apps.'
